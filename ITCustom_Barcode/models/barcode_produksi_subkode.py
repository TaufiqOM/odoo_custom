...
class BarcodeProduksiSubkode(models.Model):
    ...
    def action_generate_barcode_direct(self):
        ...
        for rec in self:
            ...
            default_code = str(rec.produk_id.default_code) if rec.produk_id and rec.produk_id.default_code else "NoCode"
            ...
            client_order_ref = str(rec.order_id.client_order_ref) if rec.order_id and rec.order_id.client_order_ref else "No Client Order Ref"
            ...
            partner_name_below = str(rec.order_id.client_order_ref) if rec.order_id and rec.order_id.client_order_ref else "No Client Order Ref"
            ...
            maph_text = str(rec.order_id.partner_id.company_registry) if rec.order_id and rec.order_id.partner_id and rec.order_id.partner_id.company_registry else "No Company Registry"
